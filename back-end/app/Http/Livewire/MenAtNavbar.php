...
class MenAtNavbar extends Component
{
    ...
    public function mount(){
        $this->products=Product::where('cat_id',2)->take(3)->get();
...
//        $qty=Product::find(1);
        ...
        return view('livewire.men-at-navbar',compact('cart','products'));
    }
    ...
    public function addItemToCart($product_ID)
    {
        ...
        return view('livewire.men-at-navbar', compact('product'));
    }
//
//
//
